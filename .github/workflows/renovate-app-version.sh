...
declare -A app_keys
app_keys=(["immich"]="immich-server immich-machine-learning" ["immich-no-machine"]="immich-server" ["stream-rec"]="stream-rec-backend stream-rec-frontend" ["rsshub"]="rsshub" ["dujiaonext"]="dujiaonext-api dujiaonext-admin dujiaonext-user")
